...
from superloss.lib.loss import (
	SuperLoss,
	HardFirstSuperLoss,
	MediumFirstSuperLoss,
	TwoEndsFirstSuperLoss,
)
from superloss.lib.nn_fns import train_superloss_one_epoch
...
def main() -> None:
	...
	superloss = superloss_class1(args.tau, args.lam, args.mom, args.mu).to(device)
	...
	for i in range(1, args.epoch + 1):
		...
		if i == args.change_epoch:
			superloss = superloss_class2(superloss.tau, args.lam, args.mom, args.mu).to(device)
